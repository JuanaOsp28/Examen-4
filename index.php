...
<html lang="en">
  ...
  <body>
    <div class="container fondo">
      ...
      <div class="row">
        <!-- //offset, para que se corra 10 espacios de los 12 disponibles -->
        <div class="col-2 offset-10">
          <div class="text-center d-flex justify-content-end">
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-primary w-30" data-bs-toggle="modal" data-bs-target="#modalUsuario" id="botonCrear">
    ...
    <!-- Modal: Ventana emergente, que permite hacer operaciones en una única página -->
